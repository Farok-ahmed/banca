              ...
              <div className="calculator mt-60">
                ...
                <div className="expected-payment mt-50 mr-30 ml-30 mb-50">
                  ...
                  <p className="text mx-sm-4 mt-20">
                    Price example: Total credit amount USD $100,000 - Maturity
                    120 months - Variable borrowing rate 7% - APR 7.24% - Etb.
                    USD $1,000 - Total repayment: USD $140,190 - Total credit
                    costs: USD $40,190 - 14-day right of withdrawal
                  </p>
