          ...
          <div className="row gy-xl-0 gy-4">
            ...
            <div className="col-xl-4 col-md-6">
              ...
              >
                ...
                <p>
                  Quis dapibus volutpat condimentum quam sed non elit sed magna
                  lectus dui interdum facilisi justo
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-5 wow fadeInLeft">
              <div className="section-title text-start">
                ...
                <ul className="list-unstyled feature-list">
                  <li>
                    <i className="fas fa-check-circle"></i> Inventore veritatis
                    et architecto beatae
                  </li>
                  <li>
                    <i className="fas fa-check-circle"></i> Tempor egestas morbi
                    pulvinar amet
                  </li>
                </ul>
              </div>
